...
Format: `editPolicy ci/CLIENT_INDEX pi/POLICY_INDEX [n/POLICY_NAME] [c/COMPANY] [pm/POLICY_MANAGER_NAME] 
[$/PREMIUM_AMOUNT]`

Examples:

- `editPolicy pi/1 ci/1 $/200`
- `editPolicy pi/1 ci/2 n/Car Insurance Plus c/Mercedes pm/Zechary $/350`

### Delete policy: `deletePolicy`

Deletes an insurance policy from a specific client

Format: `deletePolicy ci/CLIENT_INDEX pi/POLICY_INDEX`

Examples:

- `deletePolicy ci/1 pi/1`
...
| **editPolicy**    | `editPolicy ci/CLIENT_INDEX pi/POLICY_INDEX [n/POLICY_NAME] [c/COMPANY] [pm/POLICY_MANAGER_NAME] [$/PREMIUM_AMOUNT]` <br> e.g., `editPolicy pi/1 ci/1 $/200` |
| **deletePolicy**  | `deletePolicy ci/CLIENT_INDEX pi/POLICY_INDEX` <br> e.g., `deletePolicy ci/1 pi/1`                                                                           |
